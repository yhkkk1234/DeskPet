    ...
    match locked.as_ref() {
        Some(ghost) => Ok(serde_json::json!({
            ...
            "impression": {
                ...
                "opennessScore": ghost.soul.impression.openness_score,
                "conscientiousnessScore": ghost.soul.impression.conscientiousness_score,
                "extraversionScore": ghost.soul.impression.extraversion_score,
                "agreeablenessScore": ghost.soul.impression.agreeableness_score,
                "neuroticismScore": ghost.soul.impression.neuroticism_score,
                "creativityScore": ghost.soul.impression.creativity_score,
                "snippetCount": ghost.soul.impression.general_impression_snippets.len(),
                "snippets": ghost.soul.impression.general_impression_snippets.clone(),
            },
