...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::chat_commands::restore_ai_config,
            ...
            commands::chat_commands::start_recording,
            commands::chat_commands::stop_recording,
            commands::chat_commands::transcribe_audio,
